...
\newcommand{\myblagf}{how i hear my girlfriend when i'm watch my footbal team? "bla bla bla bla"}
...
\include{slides/introduction}
    ...
    \include{slides/objective}
\include{slides/relatedwork}
\include{slides/proposedwork}
